...
public class PreferenzeDiLetturaServiceImpl implements PreferenzeDiLetturaService{
     ...
     */
    @Override
    public List<Genere> getGeneriByName(String[] generi) {
    ...
    /**
     * Implementa la funzionalità di aggiungere una lista di generi ad un esperto
     * @param generi i generi da inserire
     * @param esperto l'esperto a cui inserirli
     */
    @Override
    public void addGeneriEsperto(List<Genere> generi, Esperto esperto) {
